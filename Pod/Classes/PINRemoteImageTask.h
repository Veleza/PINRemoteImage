...
- (void)callCompletionsWithQueue:(nonnull dispatch_queue_t)queue remove:(BOOL)remove withImage:(nullable PINImage *)image animatedImage:(nullable id)animatedImage cached:(BOOL)cached error:(nullable NSError *)error;
